              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-2xl font-semibold text-gray-900">$125,000</dd>
                  </dl>
                </div>
              </div>
            </div>
                  ...
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900">Laptop HP ProBook</div>
                          <div className="text-sm text-gray-500">SKU: LP-001</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">Electrónicos</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900">Monitor Dell 27"</div>
                          <div className="text-sm text-gray-500">SKU: MN-002</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
